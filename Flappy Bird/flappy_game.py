...
game_images = {}
framepersecond = 32
pipeimage = 'G:\\Python\\Flappy Bird\\Flappy_Bird_Images\\pipe.png'
background_image = 'G:\\Python\\Flappy Bird\\Flappy_Bird_Images\\background.jpg'
birdplayer_image = 'Flappy_Bird_Images\\bird.png'
sealevel_image = 'G:\\Python\\Flappy Bird\\Flappy_Bird_Images\\base.jfif'
...
if __name__ == "__main__":
	...
	game_images['scoreimages'] = (
        pygame.image.load('Flappy_Bird_Images\\0.png').convert_alpha(),
        pygame.image.load('Flappy_Bird_Images\\1.png').convert_alpha(),
        pygame.image.load('Flappy_Bird_Images\\2.png').convert_alpha(),
        pygame.image.load('Flappy_Bird_Images\\3.png').convert_alpha(),
        pygame.image.load('Flappy_Bird_Images\\4.png').convert_alpha(),
        pygame.image.load('Flappy_Bird_Images\\5.png').convert_alpha(),
        pygame.image.load('Flappy_Bird_Images\\6.png').convert_alpha(),
        pygame.image.load('Flappy_Bird_Images\\7.png').convert_alpha(),
        pygame.image.load('Flappy_Bird_Images\\8.png').convert_alpha(),
        pygame.image.load('Flappy_Bird_Images\\9.png').convert_alpha()
    )
